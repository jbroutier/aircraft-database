...
final class Version20220603104408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(
            'CREATE TABLE `aircraft_model` (
                ...
                FULLTEXT INDEX IDX_13208ADCFEC530A95E237E06 (`content`, `name`),
                PRIMARY KEY(`id`)
        ...
        $this->addSql(
            'CREATE TABLE `aircraft_type` (
                ...
                FULLTEXT INDEX IDX_586CEAD0FEC530A95E237E06 (`content`, `name`),
                PRIMARY KEY(`id`)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        ...
        $this->addSql(
            'CREATE TABLE `engine_model` (
                ...
                FULLTEXT INDEX IDX_FAFDA692FEC530A95E237E06 (`content`, `name`),
                PRIMARY KEY(`id`)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );

        $this->addSql(
            'CREATE TABLE `engine_model_picture` (
                `entity` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\',
                `picture` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\',
                INDEX IDX_80C5B917E284468 (`entity`),
                UNIQUE INDEX UNIQ_80C5B91716DB4F89 (`picture`),
                PRIMARY KEY(`entity`, `picture`)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        ...
        $this->addSql(
            'CREATE TABLE `manufacturer` (
                ...
                FULLTEXT INDEX IDX_3D0AE6DCFEC530A95E237E06 (`content`, `name`),
                PRIMARY KEY(`id`)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );

        $this->addSql(
            'CREATE TABLE `manufacturer_picture` (
                `entity` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\',
                `picture` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\',
                INDEX IDX_AB7B01DBE284468 (`entity`),
                UNIQUE INDEX UNIQ_AB7B01DB16DB4F89 (`picture`),
                PRIMARY KEY(`entity`, `picture`)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        ...
        $this->addSql(
            'ALTER TABLE `engine_model_picture` ADD (
                CONSTRAINT FK_80C5B917E284468 FOREIGN KEY (`entity`) REFERENCES `engine_model` (`id`) ON DELETE CASCADE,
                CONSTRAINT FK_80C5B91716DB4F89 FOREIGN KEY (`picture`) REFERENCES `picture` (`id`) ON DELETE CASCADE
            )'
        );
        ...
        $this->addSql(
            'ALTER TABLE `manufacturer_picture` ADD (
                CONSTRAINT FK_AB7B01DBE284468 FOREIGN KEY (`entity`) REFERENCES `manufacturer` (`id`) ON DELETE CASCADE,
                CONSTRAINT FK_AB7B01DB16DB4F89 FOREIGN KEY (`picture`) REFERENCES `picture` (`id`) ON DELETE CASCADE
            )'
        );
